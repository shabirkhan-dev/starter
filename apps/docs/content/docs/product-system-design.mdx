...
description: Product architecture, data model, services, and security model.
---
...
- `/home/shabir/Documents/Starter AI-First Smart System README.md`

Repo inputs:

- `README.md`, `PROJECT.md`, `AGENTS.md`, `DESIGN.md`
- `/docs/ai-first-workflow`
- `/docs/architecture`
- `/docs/architecture/adr-0001-strong-default-overridable`
- App code in `apps/web`, `apps/mobile`, `apps/nest-api`, `apps/docs`, and `apps/rust`
...
Starter should be built as a secure modular monolith first, with event-driven seams and clear
...
Starter is not a full ERP, LMS content marketplace, social network, or accounting system. It is a
...
server-side authorization and minimal DTOs. For Starter, use direct Hono API calls through a
...
Starter handles minors, location, attendance, education records, parent contact data, and payment
